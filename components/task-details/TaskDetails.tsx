  ...
  return (
    ...
    <div className='flex flex-col absolute left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%] group'>
      <div className='w-[95vw] max-w-[500px] max-h-[100vh] relative'>
        ...
        <Image className='max-h-[90vh] rounded-3xl' src={src || "https://images.unsplash.com/photo-1484480974693-6ca0a78fb36b?q=80&w=2072&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"} alt='Random Image' width={1000} height={700} priority={false} layout='responsive'></Image>
      <div className='transition duration-200  absolute bottom-10 left-5 z-20 group-hover:-translate-y-5 '>
        ...
        <div className='p-4 sm:text-lg md:text-xl'>{`Task ${task.id} is ${task.completed? "Complete" : "Pending"}`}</div>
      </div>
      </div>
    </div>
    </>
